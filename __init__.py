...
class SEQUENCER_PT_pallaidium_panel(Panel):  # UI
    ...
    def draw(self, context):
        ...
        if type != "text":
            if type != "audio":
                if (type == "movie" and movie_model_card != "a-r-r-o-w/animatediff-motion-adapter-sdxl-beta") or (
                    type == "image"
            ...
            if type == "audio" and audio_model_card == "bark":
                ...
                if (
                    ...
                    and image_model_card == "ByteDance/SDXL-Lightning"
                    or type == "image"
                    and image_model_card == "dataautogpt3/Proteus-RunDiffusion-Lightning"
                    or type == "image"
...
#            return {"CANCELLED"}
        ...
        # OpenPose
            ...
            #            # IPAdapter
            #            if scene.ip_adapter_face_folder or scene.ip_adapter_face_folder:
            ...
            #                      local_files_only=local_files_only,
            #                    )
            #                    pipe.set_ip_adapter_scale([0.7, 0.9])

"""Text-to-image via Krea 2 Turbo (distilled 8-step, CFG-free)."""
...
class Krea2TurboPlugin(ModelPlugin):
    MODEL_ID     = "CalamitousFelicitousness/Krea-2-Turbo-Diffusers"
    DISPLAY_NAME = "Image: Krea 2 Turbo"
    DESCRIPTION  = "Fast text-to-image via Krea 2 Turbo (12.9B MMDiT, distilled to 8 steps, CFG-free)"
    MODEL_TYPE   = "image"
    ...
    # Distilled for few-step sampling; guidance is disabled (CFG-free).

"""Fast text-to-image via ERNIE-Image-Turbo with SDNQ quantized weights."""
...
class ErnieTurboPlugin(ModelPlugin):
    ...
    def load(self, prefs, scene, **kw):
        ...
        if Version(transformers.__version__) < Version("5.0.0"):
            raise RuntimeError(
                f"ERNIE-Image-Turbo requires transformers>=5.0.0 "
        ...
        print(f"Loading ERNIE-Image-Turbo ({self.SDNQ_BITS}-bit SDNQ) from {sdnq_path}…")
